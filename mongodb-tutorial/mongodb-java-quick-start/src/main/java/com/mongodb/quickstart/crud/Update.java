...
/**
 * update, upsert, update many, 
 * find one & update (actualiza y devuelve el antiguo o el nuevo en una misma operación, según se indique)
 * */
public class Update {
    ...
    public static void main(String[] args) {
        ...
        try (MongoClient mongoClient = MongoClients.create(connectionString)) {
            ...
            Bson updateOperation = set("comment", "You should learn MongoDB!"); //USAMOS SET SI ES 1 SÓLO VALOR
            ...
            updateOperation = push("comments", "You will learn a lot if you read the MongoDB blog!"); //USAMOS PUSH SI ES UN ARRAY
            ...
            Bson update4 = addToSet("comments", "This comment is uniq"); // creating an array with a comment. //ADD TO SET   IS SIMILAR TO    PUSH,    BUT WILL ONLY ADD TO ARRAY IF IT DOESNT EXISTS.
