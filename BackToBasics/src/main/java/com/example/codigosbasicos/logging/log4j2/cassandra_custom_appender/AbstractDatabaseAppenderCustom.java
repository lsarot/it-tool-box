 ...
 */
public abstract class AbstractDatabaseAppenderCustom<T extends AbstractDatabaseManager> extends AbstractAppender {
     ...
     * @deprecated Use {@link #AbstractDatabaseAppenderCustom(String, Filter, Layout, boolean, Property[], AbstractDatabaseManager)}.
     */
    @Deprecated
    protected AbstractDatabaseAppenderCustom(final String name, final Filter filter, final boolean ignoreExceptions,
                                       final T manager) {
     ...
     * @param manager The matching {@link AbstractDatabaseManager} implementation.
     */
    protected AbstractDatabaseAppenderCustom(final String name, final Filter filter,
