 ...
 * @author Leo
 */
public class MiEtiqueta extends BodyTagSupport {
    ...
    /**
     * Fill in this method to process the body content of the tag. You only need to do this if the tag's BodyContent property is set to "JSP" or "tagdependent." If the tag's bodyContent is set to
    ...
    private void writeTagBodyContent(JspWriter out, BodyContent bodyContent) throws IOException {
        ...
        out.print("<br>Body en lowercase: "+bodyString.toLowerCase());
     ...
     *
     * @return EVAL_BODY_BUFFERED if the JSP engine should evaluate the tag body, otherwise return SKIP_BODY. This method is automatically generated. Do not modify this method. Instead, modify the
    ...
    public int doStartTag() throws JspException {
        ...
        try {
            pageContext.getOut().print("HOLA DESDE doStartTag<br>");
        } catch (IOException ex) {
            Logger.getLogger(MiEtiqueta.class.getName()).log(Level.SEVERE, null, ex);
        }
     ...
     *
     * @return EVAL_BODY_AGAIN if the JSP engine should evaluate the tag body again, otherwise return SKIP_BODY. This method is automatically generated. Do not modify this method. Instead, modify the
     * methods that this method calls.
     */
    @Override
    ...
    private void handleBodyContentException(Exception ex) throws JspException {
        ...
        throw new JspException("Error in MiEtiqueta tag", ex);
    }
